...
dose_dat <- read.csv("../clean_data/dose_inoculation_data.csv")
...
if (!file.exists("../fit_models/indiv_mortality_nolys.rds")) {
  ...
  saveRDS(mort_nolys, "../fit_models/indiv_mortality_nolys.rds")

} else { mort_nolys <- readRDS("../fit_models/indiv_mortality_nolys.rds")}
...
if (!file.exists("../fit_models/indiv_mortality_heteroHosts.rds")) {
  ...
  saveRDS(mort_heteros, "../fit_models/indiv_mortality_heteroHosts.rds")

} else { mort_heteros <- readRDS("../fit_models/indiv_mortality_heteroHosts.rds")}
...
if (!file.exists("../fit_models/indiv_mortality_homoHosts.rds")) {
  ...
  saveRDS(mort_homos, "../fit_models/indiv_mortality_homoHosts.rds")

} else { mort_homos <- readRDS("../fit_models/indiv_mortality_homoHosts.rds")}
...
if (!file.exists("../fit_models/indiv_mortality_dose_amount.rds")) {
  ...
  saveRDS(mort_dose_amount, "../fit_models/indiv_mortality_dose_amount.rds")

} else { mort_dose_amount <- readRDS("../fit_models/indiv_mortality_dose_amount.rds")}
...
if (!file.exists("../fit_models/indiv_mortality_dose_amount_mass.rds")) {
  ...
  saveRDS(mort_dose_amount_mass, "../fit_models/indiv_mortality_dose_amount_mass.rds")

} else { mort_dose_amount_mass <- readRDS("../fit_models/indiv_mortality_dose_amount_mass.rds")}
...
if (!file.exists("../fit_models/indiv_mortality_no_brain.rds")) {
  ...
  saveRDS(mort_no_brain, "../fit_models/indiv_mortality_no_brain.rds")

} else { mort_no_brain <- readRDS("../fit_models/indiv_mortality_no_brain.rds")}
...
if (!file.exists("../fit_models/indiv_mortality_viruses_both_orders.rds")) {
  ...
  saveRDS(mort_viruses_both_orders, "../fit_models/indiv_mortality_viruses_both_orders.rds")

} else { mort_viruses_both_orders <- readRDS("../fit_models/indiv_mortality_viruses_both_orders.rds")}
...
if (!file.exists("../fit_models/cfr_het2.rds")) {
    ...
    cfr_het2 <- brm(CFR_avg/100 ~ Host_order + 
        ...
        prior=custom_prior,
        iter=5000, thin=1, cov_ranef = list(Virus_ICTV=virus_cov),
        control=list(adapt_delta=0.99, max_treedepth=16), cores=4, 
        save_pars=save_pars(all=TRUE))
